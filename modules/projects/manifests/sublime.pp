class projects::sublime {
  ...
  sublime_text::package { 'Vintageous':
    source  => 'guillermooo/Vintageous',
    require => Package['Sublime Text']
  }
 ...
 sublime_text::package { 'Vintageous Surround':
  ...
  file { "$sublime_package_dir/User/Preferences.sublime-settings":
      content => template('projects/sublime/Preferences.sublime-settings'),
      require => [
        Sublime_Text::Package['Solarized Color Scheme'],
        File["$sublime_package_dir/User"]
      ],
  ...
  file { "$sublime_package_dir/User/Package Control.sublime-settings":
      content => template('projects/sublime/Package Control.sublime-settings'),
      require => [
        Package['Sublime Text'],
        File["$sublime_package_dir/User"]
      ],
  ...
  file { "$sublime_package_dir/User/SearchInProject.sublime-settings":
      content => template('projects/sublime/SearchInProject.sublime-settings'),
      require => [
        Package['Sublime Text'],
        File["$sublime_package_dir/User"]
      ],
  ...
  file { "$sublime_package_dir/User/SublimeLinter.sublime-settings":
      content => template('projects/sublime/SublimeLinter.sublime-settings'),
      require => [
        Package['Sublime Text'],
        File["$sublime_package_dir/User"]
      ],
  ...
  file { "$sublime_package_dir/User/Default (OSX).sublime-keymap":
    content => template('projects/sublime/Default (OSX).sublime-keymap'),
    require => [
      Package['Sublime Text'],
      File["$sublime_package_dir/User"]
    ],
  ...
  file { "$sublime_package_dir/User/DashDoc.sublime-settings":
    content => template('projects/sublime/DashDoc.sublime-settings'),
    require => [
      Package['Sublime Text'],
      File["$sublime_package_dir/User"]
    ],
  ...
  file { "$sublime_package_dir/User/bindingpry.sublime-snippet":
    content => template('projects/sublime/bindingpry.sublime-snippet'),
    ensure => present,
    require => [
      Package['Sublime Text'],
      File["$sublime_package_dir/User"]
  ...
  file { "$sublime_package_dir/User/consolelog.sublime-snippet":
    content => template('projects/sublime/consolelog.sublime-snippet'),
    ensure => present,
    require => [
      Package['Sublime Text'],
      File["$sublime_package_dir/User"]
